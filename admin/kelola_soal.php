...
if (isset($_POST['add_question'])) {
    ...
    if ($stmt->execute()) {
        ...
        $_SESSION['message_type'] = "error"; // Untuk tipe pesan error
    }
...
?>
 <?php if (!empty($message) && !empty($message_type)): ?>
        <script>
            SweetAlert.alert("Pesan", "<?php echo $message; ?>", "<?php echo $message_type; ?>");
        </script>
    <?php endif; ?>
...
<section id="daftar-soal" class="mt-5">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form method="GET" action="kelola_soal.php" class="row g-3 align-items-center">
                <!-- Input Pencarian -->
                <div class="col-md-6">
                ...
                <div class="col-md-4">
                    <select name="kategori" class="form-select">
                        ...
                        <option value="1" <?= (isset($_GET['kategori']) && $_GET['kategori'] == '1') ? 'selected' : ''; ?>>C1</option>
                        <option value="2" <?= (isset($_GET['kategori']) && $_GET['kategori'] == '2') ? 'selected' : ''; ?>>C2</option>
                        <option value="3" <?= (isset($_GET['kategori']) && $_GET['kategori'] == '3') ? 'selected' : ''; ?>>C3</option>
                        <option value="4" <?= (isset($_GET['kategori']) && $_GET['kategori'] == '4') ? 'selected' : ''; ?>>C4</option>
                        <option value="5" <?= (isset($_GET['kategori']) && $_GET['kategori'] == '5') ? 'selected' : ''; ?>>C5</option>
                        <option value="6" <?= (isset($_GET['kategori']) && $_GET['kategori'] == '6') ? 'selected' : ''; ?>>C6</option>
                    </select>
                </div>
                ...
                <div class="col-md-2 d-flex justify-content-between">
                    ...
                    <a href="kelola_soal.php" class="btn btn-secondary w-50">Reset</a>
                </div>
            </form>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="#" 
                                       ...
                                       onclick="setDeleteLink('kelola_soal.php?delete=<?= $row['id'] ?>')">
                                        Hapus
                                    </a>
                                </td>
                            </tr>
